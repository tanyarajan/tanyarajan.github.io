...
Untangling Informality: Wages, Preferences, and Sectoral Sorting in Bangladesh’s Garment Industry (**JMP**) 

<button  class="toggle-button" onclick="toggleAbstract('abstractText1')">Abstract</button>     <a href="https://example.com/your-pdf.pdf" class="pdf-button" target="_blank">Full Paper</a>
